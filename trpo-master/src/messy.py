...
import argparse
import signal
filename0 = '/home/initial/eclipse-workspace4/test/trpo-master/src/result'
filename1 = '/home/initial/eclipse-workspace4/test/trpo-master/src/log-files/policy_gain/'
filename2 = '/home/initial/eclipse-workspace4/test/trpo-master/src/log-files/value_gain/'
...
def main():
    ...
    aigym_path = os.path.join('/home/initial/eclipse-workspace4/test/trpo-master/src/result', env_name, now)
    env = wrappers.Monitor(env, aigym_path, force=True)
    scaler = Scaler(obs_dim)
    val_func = NNValueFunction(obs_dim, hid1_mult, filename2)
    policy = Policy(obs_dim, act_dim, kl_targ, hid1_mult, policy_logvar, filename = filename1)
